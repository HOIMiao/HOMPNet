def add_opts(parser):
    ...
    parser.add_argument("--mano_lambda_manopose", default=10, type=float,       #原10
                        help="Weight to supervise mano pose parameters")
    parser.add_argument("--mano_lambda_manoshape", default=0.1, type=float,     #原0.1
    ...
    parser.add_argument("-j", "--workers", default=16, type=int, help="number of data loading workers (default: 16)")   #16
    ...
    # options for exp
    parser.add_argument("--host_folder", default="./exp_results",
                        type=str, help="path to save experiment results")
    parser.add_argument("--pretrained_model", default="./exp_results/ho3d/checkpoint_45.pth.tar", type=str,
                        help="load trained model weights file")     # "./exp_results/ho3d/checkpoint_10.pth.tar"
    parser.add_argument("--resume", type=str, help="path to latest checkpoint")
    parser.add_argument("--evaluate", dest="evaluate", action="store_true",
                        help="evaluate model")
    parser.add_argument("--save_results", default=False, help="save output results of the network")
